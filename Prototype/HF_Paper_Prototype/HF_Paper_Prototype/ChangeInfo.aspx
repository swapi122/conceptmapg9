<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ChangeInfo.aspx.cs" Inherits="HF_Paper_Prototype.ChangeInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderDefault" runat="server">
    <div class="bs-header">
        <div class="container">
            <div class="col-lg-9">
                <h1 style="margin-top:40px;color:#0094ff;">Thay đổi thông tin tài khoản</h1>
            ...
            <div class="col-lg-12"">
                <div class="form-horizontal" style="margin-top:20px" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <button class="btn btn-info btn-lg" type="submit" value="Đăng ký">Cập nhật</button>
